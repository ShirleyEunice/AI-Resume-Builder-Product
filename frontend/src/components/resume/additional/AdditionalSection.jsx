...
const SECTIONS = [
  ...
  { key: "certifications",title: "Certificates",   subtitle: "Certifications earned",                             Component: CertificationAccordion },
...
const AdditionalSection = () => {
  ...
  const removeSection = (key) => {
    dispatch(updateResume({ section: key, data: EMPTY_DEFAULTS[key] ?? [] }));
